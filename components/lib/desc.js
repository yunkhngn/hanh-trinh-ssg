const desc = {
    ...
    about: {
        route: '/about',
        title: 'Về chúng tớ',
        url: 'https://hanhtrinhssg.tech/about-us',
        description: 'Giới thiệu tổng quan về dự án "Hành Trình SSG".',
    },
    project: {
        route: '/project',
        title: 'Kho tàng dự án',
        url: 'https://hanhtrinhssg.tech/project',
        description: 'Kho tàng dự án SSG.',
    }, 
    gallery: {
        route: '/gallery',
        title: 'Thư viện',
        url: 'https://hanhtrinhssg.tech/gallery',
    ...
    contact: {
        route: '/contact',
        title: 'Liên hệ',
        url: 'https://hanhtrinhssg.tech/contact',
